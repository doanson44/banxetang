...
public class MapObjectFactory {
	...
	public enum ObjectType {
		EAGLE, BRICK_WALL, STEEL_WALL, BUSH, WATER, ICE, BLAST, EXPLOSION, BULLET, SLOW_BULLET, FAST_BULLET, DRILL_BULLET, BLOW_BULLET, BOMB, CLOCK, HELMET, SHOVEL, STAR, TANK_ITEM, PLAYER_TANK, ENEMY_TANK
	};
