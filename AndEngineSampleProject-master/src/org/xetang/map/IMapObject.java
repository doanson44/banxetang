...
public interface IMapObject {
	...
	/**
	 * Gán tọa độ cho Sprite của đối tượng, phải được dùng <b>TRƯỚC</b> khi dùng
	...
	/**
	 * Tịnh tiến Sprite đối tượng theo độ dời tương ứng
	 */
	...
	/**
	 * Đối tượng còn sống hay không (đã bị loại khỏi trò chơi)
	 */
	 ...
	 * 
	 * @param object
	 *            : Đối tượng va chạm với đối tượng này
	 */
